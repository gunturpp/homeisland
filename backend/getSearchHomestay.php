<?php
 ...
 //   $query_user = mysqli_query($conn, "SELECT * FROM homestay where kuota >= $kuota AND alamat LIKE '%$name_homestay%'");
    $query_user = mysqli_query($conn, "select a.harga,a.foto1,a.Nama_homestay,b.id_homestay, round(AVG(b.rating),0) as rate from rating b JOIN homestay a ON b.id_homestay = a.id_homestay WHERE kuota >= $kuota AND alamat like '%$name_homestay%' GROUP by b.id_homestay,a.Nama_homestay");
